...
internal class PersonServiceTest {
    ...
    fun findAll() {
        ...
        assertTrue(personOne.links.toString().contains("</api/person/v1"))
        ...
        assertTrue(personFour.links.toString().contains("</api/person/v1"))
        ...
        assertTrue(personSeven.links.toString().contains("</api/person/v1"))
    ...
    fun createWithNullPerson(){
        val exception: Exception = assertThrows { service.create(null) }
